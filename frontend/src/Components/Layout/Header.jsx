...
function Header() {
  ...
  const tileClassName = ({ date }) => {
    ...
    return sriLankanHolidays[formatted]
      ? "bg-gradient-to-br from-red-100 to-red-200 text-red-800 font-semibold rounded-lg border border-red-300"
      : "";
  };
  ...
  const tileContent = ({ date }) => {
    ...
    if (sriLankanHolidays[formatted]) {
      return (
        <p className="text-[9px] text-red-700 mt-0.5 text-center leading-tight font-medium">
              ...
              <div className="absolute right-0 mt-4 bg-white shadow-2xl rounded-2xl p-4 z-50 w-80 border border-gray-100 animate-in slide-in-from-top-2 duration-200">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100">
                  <div className="flex items-center gap-2 text-xs text-gray-600">
                    <div className="w-3 h-3 bg-gradient-to-br from-red-100 to-red-200 rounded border border-red-300"></div>
